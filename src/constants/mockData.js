...
// Add these exports to your existing mockData.js file

export const groupsData = [
  { id: 'g1', name: 'Valorant Champions', members: 32, avatar: require('../assets/game-1.jpg'), description: 'Competitive and casual players welcome!' },
  { id: 'g2', name: 'RPG Fanatics', members: 128, avatar: require('../assets/game-2.jpg'), description: 'For lovers of deep stories and character progression.' },
  { id: 'g3', name: 'Stream Squad', members: 12, avatar: require('../assets/game-3.jpg'), description: 'Collaborate with other streamers.' },
  { id: 'g4', name: 'Indie Game Discoveries', members: 76, avatar: require('../assets/comic-4.jpg'), description: 'Sharing hidden gems and new releases.' },
];

export const callsData = [
    { id: 'c1', user: 'Jane Smith', type: 'incoming', time: 'Yesterday, 8:32 PM', duration: '5m 12s', avatar: 'https://i.pravatar.cc/150?u=jane' },
    { id: 'c2', user: 'John Doe', type: 'outgoing', time: 'Yesterday, 4:15 PM', duration: '12m 30s', avatar: 'https://i.pravatar.cc/150?u=john' },
    { id: 'c3', user: 'Stream Squad', type: 'missed', time: '2 days ago', avatar: require('../assets/game-3.jpg') },
    { id: 'c4', user: 'Jane Smith', type: 'incoming', time: '2 days ago', duration: '2m 05s', avatar: 'https://i.pravatar.cc/150?u=jane' },
];

export const arcadeGamesData = {
    featured: [
        { id: 'ag1', title: 'Cosmic Rift', genre: 'Sci-Fi Shooter', image: require('../assets/event-1.jpg') },
        { id: 'ag2', title: 'Dragon\'s Hoard', genre: 'Fantasy RPG', image: require('../assets/event-2.jpg') },
    ],
    trending: [
        { id: 'ag3', title: 'Neon Racer', image: require('../assets/event-3.jpg') },
        { id: 'ag4', title: 'Pixel Puncher', image: require('../assets/fan-art-1.jpg') },
        { id: 'ag5', title: 'Tower Tactics', image: require('../assets/comic-1.jpg') },
    ]
};
...
export const eventDetailsData = {
    'spot1': { 
        ...
        description: 'Join the Valorant tournament this Friday. Whether you\'re a seasoned pro or a newcomer, there\'s a spot for you. Prizes include in-game currency and exclusive server roles.',
     ...
     'spot2': { 
        ...
        description: 'Custom profile themes are here! Head over to the settings in your profile to check out the new appearance options and make your mark on the community.',
        image: require('../assets/event-2.jpg'),
        time: 'Live Now',
        host: 'LOLICONS Dev Team',
    }
};

// Mock data for the "Upcoming Events" section
export const upcomingEventsData = [
    {
        id: 'event1',
        title: 'Community Raid',
        time: '8:00 PM',
        gameIcon: 'game-controller', // Example Ionicons name
    },
    {
        id: 'event2',
        title: 'Dev Q&A Stream',
        time: 'Tomorrow, 5 PM',
        gameIcon: 'mic-circle',
    },
    {
...
// Mock data for the "For You" / Community section
export const forYouData = [
  {
    ...
    description: 'Connect with people you may know.',
    screen: 'Friends',
  },
  {
    id: 'foryou2',
    ...
    description: 'Listen to the latest episode now.',
    screen: 'Podcast',
  },
];
...
export const mediaData = [
  {
    ...
    poster: { uri: 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?w=500' },
    backdrop: { uri: 'https://images.unsplash.com/photo-1518676590629-3dcbd9a3d4b4?w=800' },
    type: 'K-Drama',
    tags: ['Trending', 'Romance'],
    rating: 9.2,
  ...
  },
  {
    id: 'media2',
    title: 'Dune: Part Two',
    poster: { uri: 'https://images.unsplash.com/photo-1502139214982-d0ad755818d8?w=500' },
    backdrop: { uri: 'https://images.unsplash.com/photo-1478720568477-152d9b164e26?w=800' },
    type: 'Movie',
  ...
  },
  {
    ...
    poster: { uri: 'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=500' },
    backdrop: { uri: 'https://images.unsplash.com/photo-1497032628192-86f99bcd76bc?w=800' },
    type: 'K-Drama',
  ...
  },
  {
    id: 'media4',
    title: 'Oppenheimer',
    poster: { uri: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?w=500' },
    backdrop: { uri: 'https://images.unsplash.com/photo-1504203700686-0f07992fdcfe?w=800' },
    type: 'Movie',
    tags: ['New', 'Drama'],
    rating: 8.6,
  ...
  },
  {
    id: 'media5',
    title: 'My Demon',
    poster: { uri: 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=500' },
    backdrop: { uri: 'https://images.unsplash.com/photo-1508606572321-901ea443707f?w=800' },
    type: 'K-Drama',
    tags: ['New', 'Fantasy'],
    rating: 8.1,
    description: 'A demon loses his powers after becoming entangled with a cold-hearted heiress, who may hold the key to his lost abilities — and his heart.'
  },
  {
    id: 'media6',
    title: 'The Marvels',
    poster: { uri: 'https://images.unsplash.com/photo-1549921296-3a835d3f6f26?w=500' },
    backdrop: { uri: 'https://images.unsplash.com/photo-1497032205916-ac775f0649ae?w=800' },
    type: 'Movie',
    tags: ['Action'],
    rating: 6.2,
