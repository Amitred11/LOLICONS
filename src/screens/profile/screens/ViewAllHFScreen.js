...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, ImageBackground, Image, Dimensions, StatusBar } from 'react-native';
...
const GridItem = React.memo(({ item, index, onPress, onRemove }) => {
    // Handle different data structures (MockMedia vs ComicService)
...
const ListItem = React.memo(({ item, index, onPress, onRemove }) => {
